...
ЗАПУСК
  ...
  python garmin_import.py --clear-past  # удалить только уже прошедшие (дата < сегодня)
  python garmin_import.py --clear-past --before 2026-07-01   # прошедшие до указанной даты
